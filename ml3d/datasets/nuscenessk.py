...
class NuScenesSK(BaseDataset):
    """This class is used to create a dataset based on the NuScenesSK
    ...
    def get_split(self, split):
        ...
        """
        return NuScenesSKSplit(self, split=split)
...
class NuScenesSKSplit(BaseDatasetSplit):
...
DATASET._register_module(NuScenesSK)
