...
class WaymoSK(BaseDataset):
    """This class is used to create a dataset based on the WaymoSK
    ...
    def get_split(self, split):
        ...
        """
        return WaymoSKSplit(self, split=split)
...
class WaymoSKSplit(BaseDatasetSplit):
...
DATASET._register_module(WaymoSK)
