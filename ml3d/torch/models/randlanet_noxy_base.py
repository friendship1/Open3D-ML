...
class RandLANetNoXYBase(BaseModel):
    """Class defining RandLANetNoXYBase, a Semantic Segmentation model.  Based on the
    ...
    **Architecture**
    ...
    def forward(self, inputs):
        """Forward pass for RandLANetNoXYBase
...
MODEL._register_module(RandLANetNoXYBase, 'torch')
